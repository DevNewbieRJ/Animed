...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 10-Maio-2023 às 23:40
...
CREATE TABLE IF NOT EXISTS `consultas_medicas` (
  ...
  PRIMARY KEY (`id`,`animal_id`,`veterinario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `consultas_vet` (
  ...
  PRIMARY KEY (`id`,`veterinario_id`,`animal_id`),
...
CREATE TABLE IF NOT EXISTS `pagamentos` (
  ...
  PRIMARY KEY (`id`,`consulta_id`),
  KEY `consult_fk_idx` (`consulta_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
ALTER TABLE `pagamentos`
  ADD CONSTRAINT `FK_ID_Consult_Pag` FOREIGN KEY (`consulta_id`) REFERENCES `consultas_vet` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
